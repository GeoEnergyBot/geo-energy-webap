...
export function resolveGhostUrl(level){
  return new Promise((resolve)=>{
    ...
    const fallback = 'data:image/svg+xml;utf8,' + encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"><defs><linearGradient id="g" x1="0" y1="0" x2="1" y1="1"><stop offset="0" stop-color="#88f"/><stop offset="1" stop-color="#0ff"/></linearGradient></defs><circle cx="32" cy="32" r="28" fill="url(#g)" /></svg>`);
    let i = 0;
    const img = new Image();
    const tryNext = () => {
